...
namespace AzureRelayPortBridge
{
    public class ServerTcpHybridConnectionServer : IServerTcpHybridConnectionServer
    {
            ...
            ILogger logger)
        {
            ...
            var tokenProvider = new StaticSasTokenProvider(sasTokenString);
        ...
        public async Task Stop()
        {
            ...
            {
             //without using the stream.Dispose method, the old connection do not get destroyed
                stream.Dispose();
